...
data_path = Path(rf"C:\Users\Lehnert Lab\GitHub\bcqt-ctrl\prototype_msmt_code\experiments\VNA\data")
csv_path = data_path / "raw_csvs_3"
dcm_path = data_path / "dcm_fits_3"
...
for key, processed_data_dict in processed_data.items():
    ...
    try:
        params_empty, conf_intervals, err, init1, fig = Res_PowSweep_Analysis.fit_single_res(data_df=df, save_dcm_plot=False, plot_title=key, save_path=dcm_path)
